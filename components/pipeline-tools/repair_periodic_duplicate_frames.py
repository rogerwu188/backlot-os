...
FFMPEG = Path(os.environ.get(
    "AGENTCUT_FFMPEG",
    ROOT / ".agentcut_env/lib/python3.14/site-packages/agentcut/vendor/darwin-arm64/ffmpeg",
))
...
def main() -> int:
    ...
    frames = sorted(set(int(value) for value in duplicates.get("mpdecimate_removed_frames") or []))
