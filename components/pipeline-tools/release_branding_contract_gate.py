#!/usr/bin/env python3
"""Fail closed unless a release candidate contains subtitles and Nalu Motion outro."""
...
def evaluate(
    ...
    *,
    ...
    if project.get("releaseProject") is not True:
        failures.append("release_project_not_declared")
    ...
    return {
        "schema": "backlotos.release_branding_contract_gate.v1",
