...
def evaluate_manifest(
    ...
    *,
    ...
    return {
        ...
        "policy": "The paid submit entrypoint evaluates this exact manifest fail-closed; historical gate reports are supplementary only. The series migration is E40-and-earlier Fast, E41-E44 SD2 Pro, and E45-onward MiniMax-H3. The required model and native resolution must exist in the verified provider registry. EXACT_FIRST_FRAME tasks must use image-to-video start_frame, never Omni images[], and harvested output must pass frame0 authority plus frame0-to-frame1 continuity without automatic prepend or replacement. Combat requires a viewer-readable attack-response-consequence chain, stable spatial axis, and explicit winner/loser terminal state.",
    }
